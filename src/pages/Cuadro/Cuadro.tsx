        ...
        <body className="Body_Cuadro">
            ...
            <header className="Header_Logo">
                ...
                <div className="H_Title">
                    <h1 className="Header_Title">Cuadro General de clasificacion Archivistica</h1>
                </div>
            </header>
                    ...
                    <div className="row">
                        <div className="col-12 col-lg-8 ml-auto mr-auto mb-4">
                            <div className="multisteps-form_progress">
                                <button className="multisteps-form_progress-btn js-active" type="button" title="User Info">Seccion</button>
                                <button className="multisteps-form_progress-btn" type="button" title="Address">Serie</button>
                                <button className="multisteps-form_progress-btn" type="button" title="Order Info">Subserie</button>
                                <button className="multisteps-form_progress-btn" type="button" title="Message">Resumen</button>
                            </div>
                        </div>
                    </div>
            ...
            {/*Serie*/}
            <div className="multisteps-form_panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div className="multisteps-form_content">
                    ...
                    <div className="form-row" mt-4>
                        ...
                        <div className="col-6 col-sm-3 mt-4 mt-4 mt-sm-0">
                            <label>Seccion</label>
                            <select className="multisteps-form_select form-control">Seccion
                                ...
                                <option>11C. Planeación, Información, Evaluación y Políticas</option>
                        ...
                        <div className="col">
                            ...
                            <input className="multisteps-form_input form-control" type="Select-box" placeholder="ID Serie"/>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-sm-6">
                            ...
                            <select className="multisteps-form_select form-control">
                                ...
                                <option>1C2. Convenios y tratados nacionales e internacionales.</option>
                        ...
                        <div className="col-12 col-sm-6">
                            <label>ID Serie</label>
                            <input className="multisteps-form_input form-control" type="text" placeholder="ID Subserie"/>
                        </div>
